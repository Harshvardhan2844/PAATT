        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BudgetedHours = table.Column<decimal>(type: "decimal(6,2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ProjectId = table.Column<int>(type: "int", nullable: false),
                    WeekStartingDate = table.Column<DateOnly>(type: "date", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    OverallManagerFeedback = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimesheetReviewEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimesheetReviewEvents_Timesheets_TimesheetId",
                        column: x => x.TimesheetId,
                        principalTable: "Timesheets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimesheetReviewEvents_TimesheetId_OccurredAtUtc",
                table: "TimesheetReviewEvents",
                columns: new[] { "TimesheetId", "OccurredAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Timesheets_EmployeeId_ProjectId_WeekStartingDate",
                table: "Timesheets",
                columns: new[] { "EmployeeId", "ProjectId", "WeekStartingDate" },
                unique: true);
